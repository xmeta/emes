#!/usr/bin/env python3
"""Normalize a reviewed Southwire SOOW cable snapshot into an EMES catalog."""
...
def normalize(snapshot_path: Path, output_path: Path) -> dict[str, Any]:
    ...
    source_id = "SRC_SOUTHWIRE_SOOW_569973"

    part = {
        "id": "SOUTHWIRE_SOOW_569973_6AWG_2C",
        "kind": "conductor",
        "identity": {
    ...
    catalog = {
        ...
        "catalog": {
            "id": "CAT_SOUTHWIRE_SOOW_569973",
            "name": "Southwire SOOW stock 569973 6 AWG 2-conductor cable",
            "description": (
                "Manufacturer SPEC 70002 stock 569973 construction normalized for EMES. "
                "The published 55 A ampacity remains tied to this exact two-conductor "
                "SOOW configuration and its stated NEC/CEC table basis."
            ),
        },
        "sources": [
            {
